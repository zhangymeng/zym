...
<div id="addAS" style="display:none; margin-top:20px">
<form class="layui-form" action="">  
...
<table class="layui-table" lay-data="{width: 1300, height:500, url:'<%=basePath%>/aid/findAll?aidId=${aidId}&type=1', page:true, id:'idTest'}" lay-filter="demo">
  <thead>
    <tr>
  ...
  table.on('tool(demo)', function(obj){
    ...
    //删除操作
      ...
      //layer.alert('编辑行：<br>'+ JSON.stringify(data));
    	...
    	window.location.href = "<%=basePath%>aid/aidStudent?aidId=${aidId}&dId="+data.dId;
    }
  });
		...
		$.ajax({
	        ...
	        success: function (data) {
				if(data.result==true){
	               ...
	               setTimeout(function () {
	                   window.location.href = "<%=basePath%>aid/addADPage?aidId="+aidId;
	               }, 1000);
