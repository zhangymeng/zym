...
<table class="layui-table" lay-data="{width: 1300, height:500, url:'<%=basePath%>/aid/allAS?aidId=${aidId}&dId=${dId}', page:true, id:'idTest'}" lay-filter="demo">
  <thead>
	  <tr>
      ...
      <tr>
      <th lay-data="{field:'aidTitle', width:190}">贷款项</th>
